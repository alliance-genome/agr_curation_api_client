#!/usr/bin/env python3
"""Test WBLSTerm ontology search using DatabaseMethods.

WBLSTerm - WormBase Life Stage
Record count: 774 records
...
class TestWBLSTerm(unittest.TestCase):
    """Test WBLSTerm searches using unified ontologyterm table."""

    @classmethod
    def setUpClass(cls):
        cls.db = DatabaseMethods()
        cls.ontology_type = 'WBLSTerm'
