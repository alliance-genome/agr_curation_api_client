...
class TestOBITermOntology(unittest.TestCase):
    ...
    def test_search_assay(self):
        ...
        print(f"\n✅ OBITerm 'assay': Found {len(results)} results")
    ...
    def test_search_measurement(self):
        ...
        print(f"\n✅ OBITerm 'measurement': Found {len(results)} results")
        print(f"   Sample: {result.curie} - {result.name}")
    ...
    def test_search_protocol(self):
        ...
        print(f"\n✅ OBITerm 'protocol': Found {len(results)} results")
        print(f"   Sample: {result.curie} - {result.name}")
