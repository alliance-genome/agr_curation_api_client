#!/usr/bin/env python3
"""Test XBATerm ontology search using DatabaseMethods.

XBATerm - Xenopus Anatomy Ontology
...
class TestXBATerm(unittest.TestCase):
    """Test XBATerm searches using unified ontologyterm table."""

    @classmethod
    def setUpClass(cls):
        cls.db = DatabaseMethods()
        cls.ontology_type = 'XBATerm'
