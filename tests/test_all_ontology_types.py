...
class TestAllOntologyTypes(unittest.TestCase):
    ...
    def test_all_ontology_types_accessible(self):
            ...
            try:
                ...
                for search_term in search_terms:
                    ...
                    if len(results) > 0:
                        ...
                        self.assertIsInstance(results[0], OntologyTermResult,
                            f"{ont_type}: Expected OntologyTermResult, got {type(results[0])}")
                        self.assertEqual(results[0].ontology_type, ont_type,
        ...
        self.assertEqual(accessible_count, 45,
            f"Expected all 45 ontology types to be accessible, got {accessible_count}")
