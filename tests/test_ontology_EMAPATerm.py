#!/usr/bin/env python3
"""Test EMAPATerm ontology search using DatabaseMethods.

EMAPATerm - Edinburgh Mouse Atlas Project Anatomy Ontology
Record count: 7,990 records
Test terms: "brain", "heart", "tissue"
"""
...
class TestEMAPATerm(unittest.TestCase):
    """Test EMAPATerm searches using unified ontologyterm table."""

    @classmethod
    def setUpClass(cls):
        cls.db = DatabaseMethods()
        cls.ontology_type = 'EMAPATerm'
